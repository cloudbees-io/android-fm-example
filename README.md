...
1. **Clone the repository**
    - Using Git, clone the [android-fm-example](https://github.com/cloudbees-io/android-fm-example) repository to your local machine:
...
2. **Build and open the Project:**
    - In Android Studio, select **File > New > Import Project** and open the cloned repository. You will return to the repository in step 4.
...
4. **Open the Project:** 
    - Return to your project in Android Studio.  

5. **Add the SDK Key to your application:** 
...
6. **Run the android-fm-example App:** 
   * In Android Studio, select **Play** to run the `android-fm-example` application. 
   * After running the application, the flags displayed in *Table 1* below are automatically added to your *Flags* page in the CloudBees platform.
...
- Refer to the CloudBees cloud-native platform documentation, https://docs.cloudbees.com/docs/cloudbees-platform/latest/install-sdk/[install the Feature management SDK] for more information.  
